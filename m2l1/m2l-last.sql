...
INSERT INTO `formation` VALUES (1,'math',50,150,'2017-03-19',50,'ok',1,1),(2,'foot',7,7,'2017-03-07',3,'fd',1,1),(3,'tenis',5,500,'2017-03-21',9,'okoppm',1,1),(4,'hnd',5,500,'2017-03-21',7,'okoppm',1,1),(5,'kepo',2,200,'2017-03-21',10,'pll',1,1);
...
INSERT INTO `formation_valide` VALUES (1,2,1,'valider'),(2,2,1,'valider'),(3,3,1,'refusé'),(4,4,1,'valider'),(5,5,1,'refusé'),(6,2,1,'valider'),(7,2,2,'refusé'),(8,3,2,'effectuée '),(9,4,2,'valider'),(10,5,2,'en cours de validation'),(11,5,1,'refusé'),(12,4,1,'valider'),(13,4,1,'valider'),(14,3,1,'refusé'),(15,2,2,'en cours de validation');
...
INSERT INTO `salarie` VALUES (1,'ibo','olivier','ab@ra','olivier','82e9dd1f989d339f09c629d0abd942d4','salarié',3300,3,1),(2,'adm','anis','adm@adm','anis','340969df792b7283ce86d8d427426fe8','chef d’équipe',3793,1,1),(3,'admin','admin','admin@admin','admin','vayne','admin',0,0,1);
...
-- Dump completed on 2017-06-04 17:22:36
